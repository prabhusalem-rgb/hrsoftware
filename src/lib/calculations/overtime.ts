...
//
// All overtime hours paid at 1.25x (regular rate) of hourly wage
// Hourly wage = basicSalary / (8 hours/day × 30 working days/month)
...
export function calculateOvertimePay(
  ...
  // All overtime paid at 1.25x rate regardless of day type
  const overtime = hourlyWage * 1.25 * hours;
