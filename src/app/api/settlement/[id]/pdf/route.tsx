  ...
  try {
    ...
    const statementData: SettlementStatementData = {
      ...
      settlement: {
        ...
        basic_salary: Number(payrollItem?.basic_salary) || 0,
        housing_allowance: Number(payrollItem?.housing_allowance) || 0,
        transport_allowance: Number(payrollItem?.transport_allowance) || 0,
        other_allowance: Number(payrollItem?.other_allowance) || 0,
        food_allowance: Number(payrollItem?.food_allowance) || 0,
        special_allowance: Number(payrollItem?.special_allowance) || 0,
        site_allowance: Number(payrollItem?.site_allowance) || 0,
