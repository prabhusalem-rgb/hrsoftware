...
export function TimesheetForm({ token, employees, projects }: TimesheetFormProps) {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
      ...
      {/* Hours section — regular working day with optional overtime */}
      {dayType === 'working_day' && (
      ...
      {/* Holiday Overtime — hours count as OT, user selects hours 1-8 */}
      {dayType === 'holiday_overtime' && (
        <div className="space-y-4">
          {/* Overtime Hours — user selectable 1-8 */}
          <div>
            <Label htmlFor="overtime_hours">
            ...
            <p className="text-xs text-muted-foreground mt-1">
              Select the number of overtime hours worked on the holiday. Reason is required.
            </p>
          </div>
        </div>
      )}
            ...
            <div className="space-y-4">
              <Card>
                <CardContent className="pt-4 space-y-3">
                  ...
                  {pendingData.day_type === 'holiday_overtime' && (
                    <div className="flex items-center gap-2 text-sm">
                      <Clock className="h-4 w-4 text-amber-600" />
                      <span className="font-medium">Holiday Overtime:</span>
                      <span className="text-amber-700">{pendingData.overtime_hours} hrs</span>
                    </div>
                  )}
            ...
            <div className="space-y-4">
              <Card>
                <CardContent className="pt-4 space-y-3">
                  ...
                  {submittedTimesheet.day_type === 'working_day' && (
                    <>
                      <div className="flex items-center gap-2 text-sm">
                        <Clock className="h-4 w-4 text-muted-foreground" />
                        <span className="font-medium">Regular Hours:</span>
                  ...
                  {submittedTimesheet.day_type === 'holiday_overtime' && (
                    <div className="flex items-center gap-2 text-sm">
                      <Clock className="h-4 w-4 text-amber-600" />
                      <span className="font-medium">Holiday Overtime Hours:</span>
                      <span className="text-amber-700">{submittedTimesheet.overtime_hours} hrs</span>
                    </div>
                  )}

                  {submittedTimesheet.day_type === 'absent' && (
                    <div className="flex items-center gap-2 text-sm text-red-600">
                      <AlertCircle className="h-4 w-4" />
                      <span>Absent — No hours worked</span>
                    </div>
