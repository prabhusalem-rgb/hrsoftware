...
export interface Project {
  ...
  email: string | null;
  email_sent_at: string | null;      // Timestamp of last email sent
  email_status: 'pending' | 'sent' | 'failed' | null;  // Email send status
  email_error: string | null;        // Error message if email failed
  created_at: string;
  updated_at: string;
}
